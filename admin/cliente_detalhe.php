...
<section class="content">
  ...
  <?php
    ...
    $meusDadosPainelClienteId = $clienteId;
    $meusDadosPainelEmpresaRaizId = $empresaRaizId;
    $meusDadosPainelModo = 'admin';
    ...
    $meusDadosPainelPodeUsuarios = $podeUsuarios;
    ...
    require __DIR__ . '/../includes/cliente_meus_dados_painel.php';
  ?>
